...
enum StateUpdateFlags_ : int {
	...
	StateUpdateFlags_MousePos = 1 << 1,
	StateUpdateFlags_Framerate = 1 << 2,
	StateUpdateFlags_Time = 1 << 3,
	StateUpdateFlags_CmdBuffer = 1 << 4,
	StateUpdateFlags_FontBuffer = 1 << 5,
	StateUpdateFlags_UpdateFont = 1 << 6,

	StateUpdateFlags_Display = StateUpdateFlags_DisplaySize,
